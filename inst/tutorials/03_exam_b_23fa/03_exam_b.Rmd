...
exam(
  ...
  answer(c("Plot b","Plot c", "Plot a", "Plot d"), 
         correct = TRUE),
  allow_retry = TRUE,
  arrange = "ordered",
  box = 9,
  ...
  question_dropdown(
  "A random sample of college students were asked approximately how many times they check their phone per day. The 90% confidence interval was found to be (85, 135). Which of the following is the correct interpretation of this confidence interval? <br>
  **We are 90% confident that...**",
  ...
  question_dropdown(
  "Which one of the statements below is TRUE when we increase the sample size from 100 to 800? Assume a two-tailed hypothesis test for the mean and no other alterations.",
  ...
  question_dropdown(
  paste0("In the previous question, the hypothesis test results are as follows.<br>" ,   htmltools::img(src="images/htest_1.png", height = 200, width = 500)," <br> What is the decision at the $\\alpha = 0.02$ significance level?"),
    answer("Reject the null, there is significant evidence that at least 90% of students studied.", correct = TRUE),
    answer("Fail to reject the null, there is evidence to support that at least 90% of students could have studied."),
    answer("Reject the null, there is significant evidence that less than 90% of students studied."),
    answer("Fail to reject the null, there is evidence to support that less than 90% of students studied."),
    allow_retry = TRUE,
    random_answer_order = TRUE,
    correct = "submitted",
    incorrect = "submitted",
...
Suppose we are interested in examining the difference in proportion of students who take STAT 202 at NU that are `left-brained` who believe in love at first sight and `right-brained` who believe in love at first sight.
