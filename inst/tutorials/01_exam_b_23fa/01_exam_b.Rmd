...
exam(
  ...
  question_wordbank(
  "In the histogram from the previous problem. <br> <br> Consider if the person with the lowest grade scored 5% better. <br> <br> How will the following statistics be impacted?",
