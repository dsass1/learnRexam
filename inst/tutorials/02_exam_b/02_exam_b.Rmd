...
quiz(
  ...
  paste("Q15) Which of the following will give you the area of the shaded region for a standard normal distribution? <br>", htmltools::img(src="images/normal_dist_2.png", height = 300, width = 400)) ,
    answer("pnorm(q = -2.5)"),
    answer("pnorm(q = -2.5, lower.tail = FALSE)", correct = TRUE),
...
Using our `survey` dataset, build a **parrallel slopes** multiple regression model to predict `height_inches` based on `father_height` and `gender_ident`. 
