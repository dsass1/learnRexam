...
quiz(
  ...
  #Q1
  question_dropdown(
  paste("Q1) The following code is in a code chunk:", htmltools::img(src="images/00_math6.png", height = 75, width = 200), "<br> What is the output?"),
    answer(3),
    answer("TRUE"),
    answer("FALSE", TRUE),
    answer("NA"),
  ...
  question_dropdown(
    "Q2) In a typical dataframe, ___ correspond to observations.",
    answer("columns"),
  ...
  question_dropdown("Q5) Which of the following arguments in geom_bar()
  will represent a proportion with all the bars at the top when mapping 2 categorical variables?",
    ...
    incorrect = "submitted"),
  question_dropdown(
    paste("Q6) The histogram below shows the distribution of a large company's annual employee income. Which of the following statements is TRUE concerning this distribution?", htmltools::img(src="images/02_income.png", height = 300, width = 500)),
  ...
  question_wordbank(
  "Q7) In the histogram from the previous problem. <br> Consider the person with the lowest income got a $5,000 pay cut (decrease). How will the following statistics be impacted?",
  ...
  question_wordbank(
  "Q8) Match the following statistics with whether it measures centrality, variablity, both, or neither.",
...
Construct a scatterplot of `height_inches` by `num_party`. Set the `shape` equal to `personality`.
...
ggplot(survey, aes(x = num_party, y = height_inches, shape = personality)) +
  geom_point()
```
