...
quiz(
  ...
  question_wordbank(
  paste("Q4) The table provides the first 8 observations from a sample of 200 individuals, who reported their age, race, income, and job satisfaction score on a scale from 0 to 100.", htmltools::img(src="images/01_tableB.png", height = 300, width = 500)),
  ...
  will separate stacked bars of different categories to be side-by-side when mapping 2 categorical variables?",
    ...
    incorrect = "submitted"),
  question_dropdown(
    paste("Q5) The histogram below shows the distribution of a large company's annual employee income. Which of the following statements is TRUE concerning this distribution?", htmltools::img(src="images/02_grades.png", height = 300, width = 500)),
  ...
  question_wordbank(
  "Q6) In the histogram from the previous problem. <br> How would the average grade change if the person with the lowest grade scored 5 percent better? How will the following statistics be impacted?",
  ...
  question_dropdown(
  "Q7) For the statistic, MEDIAN, indicate which of the four choices is correct.",
  ...
  question_dropdown(
  "Q8) For the statistic, MINIMUM, indicate which of the four choices is correct.",
  ...
  question_dropdown(
  "Q12)  Suppose we have a dataset (some data) and we want to remove invalid data entries for one of the numerical variables and then proceed to calculate the median for that variable per level/category for a categorical variable. Which general sequence of functions/verbs would achieve this?",
