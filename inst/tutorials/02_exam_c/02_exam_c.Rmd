...
quiz(
  ...
  #Q1
  question_dropdown(
  "Q1) Consider the relationship between a US adult's shoe size and the number of movies watched a year. <br>
  Choose the option that best describes the correlation.",
    ...
    incorrect = "submitted"),
  question_dropdown(
    paste("Q2) Examine the graph below and then select the best estimate of the correlation. <br>", htmltools::img(src="images/cor_1.png", height = 200, width = 200)),
    answer("-0.6"),
    answer("-0.3"),
    answer("0"),
  ...
  question_dropdown(
  paste("Q3) You run a simple linear regression model to predict student SAT math scores (`sat_math`) based on the state's percentage of seniors/juniors taking the SAT (pct_taking). The model fitted value and residual for 5 states were added to the dataset and are shown below. <br>", htmltools::img(src="images/lm_sat_2.png", height = 150, width = 500), "<br> Did the model over-, under-, or correctly estimate the mean SAT math score for FL (Florida)?"),
  ...
  question_dropdown(
  "Q4) Using the table from Q3, which of the five states does the model estimate best?",
    answer("FL"),
    answer("IL"),
    answer("NM"),
  ...
  question_numeric(
  "Q5) Using the table from Q3, what is the fitted/predicted value for New Mexico (`NM`)?",
  ...
  question_radio(
  "Q6) Consider the following model where graduation rate (rate) and whether or not the college is public or private (type) are the explanatory/predictor variables to predict college tuition cost. The reference group for type is **public**. <br>
  ...
  What is the correct interpretation for $b_1$.",
    ...
    answer("offset in intercept for private colleges"),
  ...
  question_radio(
  "Q7) Consider the following model where graduation rate (rate) and whether or not the college is public or private (type) are the explanatory/predictor variables to predict college tuition cost. The reference group for type is **public**. <br>
  $\\widehat{tuition} = b_0 + b_1(rate) + b_2(type)$ <br><br>
  What is the correct interpretation for $b_2$.",
    ...
    answer("slope of graduation rate for public colleges"),
    answer("slope of graduation rate for private colleges"),
    answer("slope of graduation rate for both public and private colleges"),
    allow_retry = TRUE,
    random_answer_order = FALSE,
    incorrect = "submitted"
  ),
  ...
  question_dropdown(
    "Q18) Consider the following headline: 'Video games cause violent behavior'”'. What conclusions can you infer?",
    answer("video games cause violent behavior, because this would be an observational study."),
    answer("video games are only correlated with violent behavior, because this would be an observational study", correct = TRUE),
    answer("video games cause violent behavior, because this would be a randomized experiment."),
    answer("video games are only correlated with violent behavior, because this would be a randomized experiment."),
    allow_retry = TRUE,
    random_answer_order = TRUE,
    incorrect = "submitted"
  ),
  question_dropdown(
    "Q19) A manufactorer wants to check the rate of defective products that a machine produces. The quality control worker selects the first 100 items produced as their sample and determines the proportion of items that are defective. What type of sample is this?",
  ...
  question_dropdown(
    "Q20) A worldwide survey was conducted via the internet to determine overall happiness and quality of life. The average happiness rating for all countries was 6 out of 10.",
