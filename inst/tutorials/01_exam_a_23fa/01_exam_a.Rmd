...
- compute the mean and standard deviation of `followers_insta` by `personality`
...
Construct a histogram of `followers_insta`. Facet the histogram based on `personality`. Choose an appropriate number of bins and change the border color to "white".
