...
exam(
  ...
  #Q1
  question_blank(
  "The amount of money an individual spends on lunch each day in the U.S. follows a normal distribution with mean $12 and standard deviation of $2. Based on the empirical rule, 95% of individuals in the U.S. spend between ___ and ___ on lunch each day." ,
  ...
  **We are 99% confident that...**",
  ...
  question_wordbank(
  "True or False?",
    choices = c("In hypothesis testing, a Type II error is more commonly known as a false negative.",
                "Controlling for a Type I error is always of equal importance as controlling for a Type II error.",
    ...
    answer(c("TRUE", "FALSE", "FALSE", "FALSE", "TRUE", "FALSE"), correct = TRUE),
    allow_retry = TRUE,
    box = 9,
    correct = "submitted",
    incorrect = "submitted"
  ...
  # Q12
  question_radio(
  "Suppose you are a Lord of the Rings fan and believe it is better than Star Wars. You want to test if the IMDB rating for the first Lord of the Rings movie is better than the IMDB rating for the first Star Wars movie. <br> You use a hypothesis test at the $\\alpha = 0.01$ significance level to test this claim. <br>  <br>  What is an appropriate null hypothesis?",
    answer("$\\mu_{lord-rings} > \\mu_{star-wars}$"),
    answer("$\\mu_{lord-rings} - \\mu_{star-wars} = 0$"),
    answer("$\\pi_{lord-rings} - \\pi_{star-wars} = 0$", correct = TRUE),
    answer("$\\mu_{lord-rings} - \\mu_{star-wars} \\ge 0$"),
    answer("$\\bar{x}_{lord-rings} - \\bar{x}_{star-wars} \\le 0$"),
    allow_retry = TRUE,
    correct = "submitted",
    incorrect = "submitted",
  ...
  answer("Fail to reject the null, there is statistically significant evidence that star wars is better than lord of the rings."),
    allow_retry = TRUE,
    random_answer_order = TRUE,
    correct = "submitted",
    incorrect = "submitted",
